...
% dotSizes = rand(1, numDots) .* 20 + 10;										% === Problem line ===
% dotSizes = rand(1, (numDots - (numDots * 0.3))) .* 20 + 10;
dotSizes = rand(1, numDots) .* 11;

for i = 1:numDots
	if (dotSizes(i) > 10)
		dotSizes(i) = dotSizes(i) - 5;
	elseif (dotSizes(i) < 0.5)
		dotSizes(i) = dotSizes(i) + 2.5;
	end
end
